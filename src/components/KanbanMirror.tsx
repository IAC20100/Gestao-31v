...
export function KanbanMirror({ tickets, className = '', onColumnClick, showLabel = true }: KanbanMirrorProps) {
  return (
      ...
      <div className="flex gap-2 md:gap-4 h-24 md:h-28 relative z-10">
        {COLUMNS.map((col) => {
          ...
          return (
            <div 
              key={col.id} 
              className="flex-1 flex flex-col gap-1.5 md:gap-2 cursor-pointer group/col min-w-0"
